...
//I think that this XYvertex stuff is taken care of in the int x line above. Why is it here twice?
        if (XYVertex)
            cy = new int[] {x,x+s,x+s+t,x+s,x,x-t};  //this is for the top left vertex being at x,y. Which means that some of the hex is cutoff.
        else
            cy = new int[] {x+t,x+s+t,x+s+t+t,x+s+t,x+t,x};	//this is for the whole hexagon to be below and to the right of this point

        cx = new int[] {y,y,y+r,y+r+r,y+r+r,y+r};
    ...
    public static void fillHex(int i, int j, int n, Graphics2D g2) {
        ...
        if (n > 0) {
            ...
            c = (char)n;
            g2.drawString(""+c, y+r+BORDERS, x+r+BORDERS+4); //FIXME handle XYVertex
